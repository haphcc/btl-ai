...
**Định nghĩa:** "Unsupervised learning involves finding patterns in data that has **not been labeled or classified**. The goal is to discover hidden structures or to estimate the probability density of the data." **Nguồn:** Bishop, C. M. (2006). *Pattern Recognition and Machine Learning* (p. 3). Springer.
