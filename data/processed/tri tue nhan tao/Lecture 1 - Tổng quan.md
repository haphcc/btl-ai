...
## **Kiểm tra IQ**
- Thử làm bài kiểm tra IQ tại: https://test.iqtestacademy.org/
...
Hoạt động tự chủ và thích nghi với môi trường mới.

### **3. Nhận dạng và Hiểu (Recognition and Understanding)**
Nhận dạng các mẫu, đối tượng và hiểu ngôn ngữ tự nhiên ở một mức độ nào đó.

# Siri virtual assistant

- 12:13
- 4G
- Hey Siri how do you cook an omelette
- Tap to Edit >
...
- WEBSITES
    ...
    - How to cook the perfect omelette recipe - BBC Food
    - How to Make an Omelette - Delia's How to Cook - BBC Food ...
...
- Memories
- Favorites
- Exploring AUG 19, 2021
- Greenbrae AUG 18, 2022
- Library
- For You
- Albums
- Search
...
- LCLOTUS Copper Water Bottle Joint Free and Leak
...
- Red-light running(car,bus,truck)
- car v: 8 15A74385
- car v: 2 15K02399
...
# Phép thử Turing (The Turing Test)
...
**Hình ảnh minh họa:**
- Computer running an intelligent program
- Closed Room
- Interrogator
...
| :--- | :--- | :--- | :--- |
| **MMLU** <br> Multiple-choice questions in 57 subjects (professional & academic) (Hendrycks et al., 2021a) | **90.04%** <br> CoT@32* | 79.13% <br> CoT@8* | 87.29% <br> CoT@32 <br> (via API**) |
| | 83.7% <br> 5-shot | 71.8% <br> 5-shot | 86.4% <br> 5-shot <br> (reported) |

# 1.2. Các khái niệm cơ bản về AI

- **John McCarthy** (1955): AI – Artificial Intelligence – Trí tuệ nhân tạo là bộ môn khoa học và kĩ thuật chế tạo *máy thông minh*.
...
- **K. R. Chowdary (2020):** AI – Trí tuệ nhân tạo (Trí thông minh nhân tạo) là một nhánh trong lĩnh vực Khoa học máy tính, chủ yếu liên quan đến việc *tự động hóa các hành vi thông minh*.
*(K. R. Chowdary - Fundamentals of Artificial Intelligence-Springer-Nature New York Inc (2020)*
...
# Phân loại theo khả năng của AI
...
| Data | Training | Foundation Model | Adaptation | Tasks |
| :--- | :--- | :--- | :--- | :--- |
...
- **Labelled Historic Data on Credit**
- ~80%
- **Lending Decision** 1 0
- **Training Set**
- **Risk ML Model**
- **Lending Decision Predictions**
- **Logistic Regression**
- ~20%
- 632 **Average**
- **Decile Methodology**
...
| :--- | :--- |
| **1900 - 1950** | 1900: Triode Vaccum Tube<br>1920: First ever robot<br>1938: Digital Logic<br>1948: Cybernetics |
| **1950 - 1973** | 1950: Turing Test ("A computer would deserve to be called intelligent if it could deceive a human into beliving it was human")<br>1956: **AI term born** ("A paper called the Dartmouth Proposal is presented in which, for the first time, the AI definition is used.")<br>1957: First Perceptron<br>1957: First AI program<br>1965: First Ind. Robot<br>1965: Eliza ChatBot! |
| **1980 - 1987** | 1980: WABOT-2<br>1982: Hopfield ANN<br>1986: Parallel Processing<br>1986: Back propagation ("Multi-layer networks could learn non-linear mappings, significantly contributing to the field's progress")<br>1989: Convolutional NN |
| **1993 - 2000** | 1994: Robocup<br>1997: Deep Blue ("IBM's Deep Blue defeats chess world champion Garry Kasparov.")<br>1997: LSTM ANN<br>1999: Sony AIBO<br>2000: Kismet Robot |
| **2000 - 2012** | 2003-2005: DARPA Challenges<br>2006: Deep Belief ANN<br>2008: IBM Blue Brain<br>2010: Apple Siri<br>2012: AlexNet ("A Revolutionary Deep Learning Architecture significantly outperforms ImageNet") |
| **2012 - 2017** | 2013: DeepMind<br>2014: Generative AN<br>2015: Tensorflow<br>2016: Alpha Go<br>2017: Transformers ("Attention Is All You Need") |
| **2017 - 2020** | 2017: WaveNet<br>2019: GPT-1<br>2020: BERT LM<br>2020: GPT-3<br>2020: DALL-E ("generating images from descriptions, showcases the power of AI in cross-modal tasks and creative content generation") |
| **2020 - 2025** | 2020: Tesla Self drive<br>2021: Regulation & Ethics<br>2022: **ChatGPT** ("OpenAI ChatGPT became the fastest growing consumer software application in history just after 2 months!")<br>2024: Sora LVM<br>2024: EU AI Act<br>2025: **deepseek** ("The chinesse deepseek overpasses OpenAI in 2 weeks!") |
| **2025 - ...** | +2025: AGI, ASI, Singularity, SuperHumans & Beyond |

*Lưu ý: Biểu đồ có đánh dấu các giai đoạn "1st Winter" và "2nd Winter".*

# An example from machine translation evolution

- I like the black cat
- I/P like/V the/D black/A cat/N
- Tôi thích con mèo màu đen
...
*Parallel sentence pairs corpus, Hidden Markov Model, Alignment, Statistical model, Language model
...
Recurrent neural networks, Attention mechanism, Transformers, Word2Vec
...
- **Machine Learning**: A subfield of AI that focuses on enabling computers to learn from data and improve their performance over time without explicit programming.
...
- **Computer Vision**: A subfield of AI that focuses on enabling computers to understand and interpret visual information, such as images and videos.

- **Robotics**: A subfield of AI that focuses on the design and development of robots and other physical devices that can perform tasks and actions in the real world.

- **Knowledge Representation and Reasoning**: A subfield of AI that focuses on the representation and manipulation of knowledge and information in a machine, and the ability of the machine to reason and make decisions based on that knowledge.

- **Neural Networks and Deep Learning**: A subfield of AI that focuses on the use of artificial neural networks, a type of machine learning algorithm, to process and analyze large amounts of complex data, such as in the case of image and speech recognition.
...
## MACHINE LEARNING
- **INPUT**: Hình ảnh xe hơi
- **FEATURE EXTRACTION**: Con người trích xuất đặc trưng
- **CLASSIFICATION**: Phân loại
- **OUTPUT**: CAR / NOT CAR

## DEEP LEARNING
- **INPUT**: Hình ảnh xe hơi
- **FEATURE EXTRACTION + CLASSIFICATION**: Mạng nơ-ron tự động thực hiện
- **OUTPUT**: CAR / NOT CAR
...
- **Dịch máy**
- **Phản hồi câu hỏi**
    - Có chương trình ưu đãi không?
    - Hiện tại cửa hàng đang có ưu đãi mua 1 tặng 1?
...
| | |
| :--- | :--- |
| **VI PHẠM TỐC ĐỘ** | **VI PHẠM TÍN HIỆU ĐÈN GIAO THÔNG** |
| **VI PHẠM DỪNG ĐỖ** | **VI PHẠM SAI LÀN** |
