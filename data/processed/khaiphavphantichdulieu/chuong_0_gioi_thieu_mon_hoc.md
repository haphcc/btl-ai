...
## Chương 1. Tổng quan về phân tích và khai phá dữ liệu

## Chương 2. Các vấn đềtiền xửlý dữ liệu
...
C1: Tổng quan về phân tích và khai 1 9 Kiểm tra 1 phá dữ liệu

2 C2: Tiền xử lý dữ liệu 10 C5: Phân cụm dữ liệu

3 Thực hành Tiền xử lý dữ liệu 11 C5: Phân cụm dữ liệu

4 C3: Mô hình hồi quy 12 Thực hành phân cụm dữ liệu

5 C3: Mô hình hồi quy 13 C6: Khai phá luật kết hợp

6 C4: Phân lớp dữ liệu 14 Thực hành khai phá luật kết hợp
...
| Buổi | Nội dung | Buổi | Nội dung |
| --- | --- | --- | --- |
| 1 | C1: Tổng quan về phân tích và khai
phá dữ liệu | 9 | Kiểm tra 1 |
| 2 | C2: Tiền xử lý dữ liệu | 10 | C5: Phân cụm dữ liệu |
| 3 | Thực hành Tiền xử lý dữ liệu | 11 | C5: Phân cụm dữ liệu |
| 4 | C3: Mô hình hồi quy | 12 | Thực hành phân cụm dữ liệu |
| 5 | C3: Mô hình hồi quy | 13 | C6: Khai phá luật kết hợp |
...
Có mặt tại lớp hơn 75%.

Đọc trước tài liệu tham khảo cho mỗi chương.
