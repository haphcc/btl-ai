...
(Biểu đồ Pareto hiển thị các nguyên nhân gây trễ giờ, với trục tung bên trái là số lượng và trục tung bên phải là tỷ lệ phần trăm tích lũy. Các nguyên nhân bao gồm: Traffic, Child care, Public transportation, Weather, Overslept, Emergency.)
...
(Biểu đồ cột thể hiện phân phối điểm số môn Tiếng Anh năm 2019 với trục hoành là điểm số từ 0 đến 10 và trục tung là số lượng thí sinh.)

## Marketing Spending (£ 000)

(Biểu đồ phân tán thể hiện mối quan hệ giữa Marketing Spending và Sales growth.)
...
**366** TNG S KHCH HNG
**2,370,406,065.125 VN** CHI TIU
1263 Ha n
1,876,806 VN/Ha n

**TN SUT KHCH N N**
- Khch quay li trong 1 tun: 60
- Khch quay li trong 2 tun: 141
- Khch quay li trong 3 tun: 65
- Khch quay li trong 1 thng: 25
- Khch quay li trong 2 thng: 42
- Khch quay li trn 2 thng: 71

**22** KHCH HNG S DNG VOUCHER TRN 2 LN

---

### KHCH N 3 LN TR LN
CHI TIU 2,240,667,928.125 VN (95%)
- **78** Khch hng (Chim 35%)
- 1083 Ha n
- 2,068,945 VN/Ha n

### KHCH N 2 LN
CHI TIU 74,337,976 VN (3%)
- **38** Khch hng (Chim 17%)
- 76 Ha n
- 978,131 VN/Ha n

### KHCH N LN U
CHI TIU 55,400,161 VN (2%)
- **104** Khch hng (Chim 47%)
- 104 Ha n
- 532,694 VN/Ha n
...
| Cấp độ | Mô tả |
| :--- | :--- |
| **Prescriptive** | Ok, what should we do? |
...
- **BI** là tập các công nghệ và công cụ để chuyển đổi những dữ liệu thô thành những thông tin có nghĩa và có ích cho mục đích phân tích kinh doanh
...
- **Tóm lại: BI là qui trình và công nghệ mà các doanh nghiệp dùng để :**
    - kiểm soát khối lượng dữ liệu khổng lồ,
...
1. Thu thập và lưu trữ dữ liệu hoạt động (operation data)
2. Tổng hợp dữ liệu thô thành dữ liệu hỗ trợ quyết định
3. Phân tích dữ liệu hỗ trợ quyết định để tạo ra thông tin
...
- **Được tích hợp (integrated):** Kho dữ liệu là một cơ sở dữ liệu hợp nhất, tập trung, tích hợp dữ liệu lấy từ toàn bộ tổ chức và từ nhiều nguồn với các định dạng đa dạng.
...
## TABLE 13.7 Characteristics of Data Warehouse Data and Operational Database Data
...
**FIGURE 16.3** Hadoop Distributed File System (HDFS)
...
| :--- | :--- | :--- | :--- |
| Block 1 | Block 2 | Block 1 | Block 3 | Block 2 | Block 3 | Block 1 | Block 2 |
...
- map -> 54778-2T: 2
- map -> 2238/QPD: 1, 1546-QQ2: 1, 13-Q2/P2: 5
- map -> 54778-2T: 3, 23109-HB: 2
...
- **Mỗi cặp Key-value thường được coi là một nhóm (bucket).**
...
| Key | Value |
| :--- | :--- |
| 10010 | “LName Ramas FName Alfred Initial A Areacode 0161 Phone 844-2573 Balance 0” |
...
| Cus_Code | Cus_LName | Cus_FName | Cus_City | Cus_Country |
| :--- | :--- | :--- | :--- | :--- |
...
| 10014 | Orlando | Myron | | |
| 10015 | O'Brian | Amy | Durban | SA |
| 10016 | Brown | James | | |
| 10017 | Williams | George | Utrecht | NL |
| 10018 | Farriss | Anne | Cape Town | SA |
...
- **Block 1**: 10010,Ramas,Alfred,Manchester,UK; 10011,Dunne,Leona,Durban,SA
- **Block 2**: 10012,Smith,Kathy,Paris,FR; 10013,Olowski,Paul,Manchester,UK
- **Block 3**: 10014,Orlando,Myron,NULL,NULL; 10015,O'Brian,Amy,Durban,SA
- **Block 4**: 10016,Brown,James,NULL,NULL; 10017,Williams,George,Utrecht,NL
- **Block 5**: 10018,Farriss,Anne,Cape Town,SA; 10019,Smith,Olette,Manchester,UK

### **Column-centric storage**

- **Block 1**: 10010,10011,10012,10013,10014,10015,10016,10017,10018,10019
- **Block 2**: Ramas,Dunne,Smith,Olowski,Orlando,O'Brian,Brown,Williams,Farriss,Smith
